...
const ALL_STEPS: Step[] = [
  ...
  },
  {
    title: "Dashboard",
    badge: "Inicio · /",
    description: "Panel principal con todos los indicadores clave de producción actualizados en tiempo real.",
    details: [
      "KPIs: producción acumulada, productividad (t/h), inventario y despachos",
      "Gráfico semanal con barras de producción y línea de KPI objetivo (32 t/h)",
      "Capacidad histórica de canchas con barras de progreso",
      "Sparklines de tendencia en cada tarjeta de indicador",
    ],
    color: "#2563eb",
    icon: "chart",
  },
  ...
  {
    title: "Registros Arena",
    badge: "Registros · /arena  (solo admin)",
    description: "Ingreso y edición de cubicaciones del drone. Cada registro captura todos los datos de un vuelo.",
    details: [
      "Producción y productividad medida por el drone",
      "Producción y KPI según pesómetro (para comparativa)",
      "Horas reales trabajadas y horas de detención",
      "Inventario en toneladas al momento de la cubicación",
      "Muestra valores del registro anterior para referencia",
    ],
    color: "#059669",
    adminOnly: true,
    icon: "register",
  ...
  },
  {
    ...
    description: "Inteligencia artificial para consultar datos de producción en lenguaje natural. Disponible en la esquina inferior derecha.",
    details: [
      "Pregunta sobre producción, inventario o despachos con tus propias palabras",
      "Respuestas con datos reales de Supabase actualizados",
