...
// Escrituras a registros_cuarzo/historial_cambios pasan por API con sesión admin
...
export function EditCuarzoModal({ registro, userEmail, onClose, onSaved }: Props) {
  ...
  async function handleSave() {
    ...
    try {
      await writeRegistro({ table: "registros_cuarzo", op: "update", id: registro.id, patch: update });
    } catch (e) {
  ...
  async function recalcular() {
    ...
    try {
      const r = await fetch("/api/registros/recalcular", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ tabla: "cuarzo", registroId: registro.id }),
      });
